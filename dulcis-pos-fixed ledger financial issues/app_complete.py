...
app.config['MAIL_USERNAME'] = 'elijah.poseo8@gmail.com'
app.config['MAIL_PASSWORD'] = 'xlsk jmgx egxz seef'
app.config['MAIL_DEFAULT_SENDER'] = ('StockSecure POS', 'elijah.poseo8@gmail.com')
mail = Mail(app)
